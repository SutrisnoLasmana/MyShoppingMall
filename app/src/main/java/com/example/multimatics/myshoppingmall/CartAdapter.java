...
public class CartAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //Klik kanan di item_row_cart - Generate - ButterKnife
        ...
        holder.tvProdukName.setText(item.getName());
        holder.tvProdukPrice.setText(String.valueOf(item.getPrice()));
        Glide.with(activity).load(item.getImage()).into(holder.imgProduct);
        int subTotal = getSubTotal(item.getQty(), item.getPrice());
        holder.tvProdukSubTotal.setText(String.valueOf(subTotal));
        ...
        holder.imgDelete.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                event.setEventMessage("Deleted Item");

                EventBus.getDefault().post(event);
            }
        }));

        holder.spnQty.setOnItemSelectedListener(new CustomOnItemSelectedListener(position, holder.tvProdukSubTotal, new CustomOnItemSelectedListener.OnItemSelectedCallback() {
            @Override
    ...
    private int getSubTotal(int qty, double price) {
    ...
    static class ViewHolder {
        ...
        @BindView(R.id.tv_produk_name)
        TextView tvProdukName;
        @BindView(R.id.tv_produk_price)
        TextView tvProdukPrice;
        @BindView(R.id.spn_qty)
        Spinner spnQty;
        @BindView(R.id.tv_produk_sub_total)
        TextView tvProdukSubTotal;
